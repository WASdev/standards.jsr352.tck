...
@javax.inject.Named("jobContextExitStatusListener")
public class JobContextExitStatusListener extends AbstractJobListener {
    ...
    public void afterJob() throws Exception {
    	...
    	if(!jobExitStatus.equals(expectedJobExitStatus)){
